    ...
    try {
      ...
      const zones = [
        {
          ...
          points: [
            [0, 0],
            [9.6, 0],
            [8.2 + (1.4 * cos60), 1.4 * sin60],
            [8.2 + (1.2 * cos60), 1.2 * sin60],
            [9.4 - (1.7 * cos60), 1.7 * sin60],
            [1.7 * cos60, 1.7 * sin60]
          ]
        },
        {
          id: 'D2', label: 'D2', color: '#DDA0DD',
          centroid: { x: 4.5, y: 4.0 * sin60 },
          points: [
            [1.7 * cos60, 1.7 * sin60],
            [9.4 - (1.7 * cos60), 1.7 * sin60],
            [9.4 - (2.9 * cos60), 2.9 * sin60],
            [8.5 - (2.9 * cos60), 2.9 * sin60],
            [8.5 - (4.3 * cos60), 4.3 * sin60],
            [7.8 - (4.3 * cos60), 4.3 * sin60],
            [7.8 * cos60, 7.8 * sin60]
          ]
        },
        {
          id: 'DT', label: 'DT', color: '#F39C12',
          centroid: { x: 6.5, y: 5.5 * sin60 },
          points: [
            [8.5 - (2.9 * cos60), 2.9 * sin60],
            [9.4 - (2.9 * cos60), 2.9 * sin60],
            [4.6 + (4.8 * cos60), 4.8 * sin60],
            [4.6 + (4.4 * cos60), 4.4 * sin60],
            [9 * cos60, 9 * sin60],
            [7.8 * cos60, 7.8 * sin60],
            [7.8 - (4.3 * cos60), 4.3 * sin60],
            [8.5 - (4.3 * cos60), 4.3 * sin60]
        ...
        },
        {
          ...
          points: [
            [9.8, 0],
            [10, 0],
            [10 - (0.2 * cos60), 0.2 * sin60]
          ]
        },
        {
          id: 'T1', label: 'T1', color: '#4ECDC4',
          centroid: { x: 9.0, y: 1.5 * sin60 },
          points: [
            [9.6, 0],
            [9.8, 0],
            [10 - (0.2 * cos60), 0.2 * sin60],
            [10 - (1.8 * cos60), 1.8 * sin60],
            [8.2 + (1.4 * cos60), 1.4 * sin60]
          ]
        },
        {
      ...
      legendData.forEach((item, i) => {
        const row = legend.append('g')
          .attr('transform', `translate(6, ${10 + i * 18})`);
  ...
  if (!data || data.length === 0) {
    return (
      <div style={styles.noDataContainer}>
        <p>No Duval Triangle 6 data available</p>
      </div>
    );
  }
