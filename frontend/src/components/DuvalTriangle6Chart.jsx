// frontend/src/components/DuvalTriangle6Chart.jsx

import React, { useEffect, useRef, useState } from 'react';

const DuvalTriangle6Chart = ({ data, width = 650, height = 600 }) => {
  const svgRef = useRef();
  ...
  const renderChart = async () => {
    try {
      ...
      console.error('Error rendering Duval Triangle 6 chart:', err);
  ...
  const renderWithD3 = (d3, svg) => {
    try {
      ...
      const zones = [
        {
          id: 'D1', color: '#FFEAA7',
          centroid: { x: 2.0, y: 2.5 * sin60 },
          points: [
            [0, 0],
            [9.6, 0],
            [8.2 + (1.4 * Math.cos(Math.PI/3)), 1.4 * sin60],
            [8.2 + (1.2 * Math.cos(Math.PI/3)), 1.2 * sin60],
            [9.4 - (1.7 * Math.cos(Math.PI/3)), 1.7 * sin60],
            [1.7 * Math.cos(Math.PI/3), 1.7 * sin60]
          ]
        },
        {
          id: 'D2', color: '#DDA0DD',
          centroid: { x: 4.5, y: 4.0 * sin60 },
          points: [
            [1.7 * Math.cos(Math.PI/3), 1.7 * sin60],
            [9.4 - (1.7 * Math.cos(Math.PI/3)), 1.7 * sin60],
            [9.4 - (2.9 * Math.cos(Math.PI/3)), 2.9 * sin60],
            [8.5 - (2.9 * Math.cos(Math.PI/3)), 2.9 * sin60],
            [8.5 - (4.3 * Math.cos(Math.PI/3)), 4.3 * sin60],
            [7.8 - (4.3 * Math.cos(Math.PI/3)), 4.3 * sin60],
            [7.8 * Math.cos(Math.PI/3), 7.8 * sin60]
          ]
        },
        {
          id: 'DT', color: '#F39C12',
          centroid: { x: 6.5, y: 5.5 * sin60 },
          points: [
            [8.5 - (2.9 * Math.cos(Math.PI/3)), 2.9 * sin60],
            [9.4 - (2.9 * Math.cos(Math.PI/3)), 2.9 * sin60],
            [4.6 + (4.8 * Math.cos(Math.PI/3)), 4.8 * sin60],
            [4.6 + (4.4 * Math.cos(Math.PI/3)), 4.4 * sin60],
            [9 * Math.cos(Math.PI/3), 9 * sin60],
            [7.8 * Math.cos(Math.PI/3), 7.8 * sin60],
            [7.8 - (4.3 * Math.cos(Math.PI/3)), 4.3 * sin60],
            [8.5 - (4.3 * Math.cos(Math.PI/3)), 4.3 * sin60]
          ]
        ...
        {
          id: 'PD', color: '#FF6B6B',
          centroid: { x: 9.9, y: 0.5 * sin60 },
          points: [
            [9.8, 0],
            [10, 0],
            [10 - (0.2 * Math.cos(Math.PI/3)), 0.2 * sin60]
          ]
        },
        {
          id: 'T1', color: '#4ECDC4',
          ...
          points: [
            ...
            [9.8, 0],
            [10 - (0.2 * Math.cos(Math.PI/3)), 0.2 * sin60],
            [10 - (1.8 * Math.cos(Math.PI/3)), 1.8 * sin60],
            [8.2 + (1.4 * Math.cos(Math.PI/3)), 1.4 * sin60]
          ]
        },
        {
          id: 'T2', color: '#45B7D1',
          centroid: { x: 7.5, y: 3.0 * sin60 },
          points: [
            [8.2 + (1.2 * Math.cos(Math.PI/3)), 1.2 * sin60],
            [10 - (1.8 * Math.cos(Math.PI/3)), 1.8 * sin60],
            [10 - (5.4 * Math.cos(Math.PI/3)), 5.4 * sin60],
            [4.6 + (4.8 * Math.cos(Math.PI/3)), 4.8 * sin60]
          ]
        },
        {
          id: 'T3', color: '#96CEB4',
          centroid: { x: 6.0, y: 7.0 * sin60 },
          points: [
            [4.6 + (4.4 * Math.cos(Math.PI/3)), 4.4 * sin60],
            [10 - (5.4 * Math.cos(Math.PI/3)), 5.4 * sin60],
      ...
      const colorScale = d3.scaleOrdinal()
        .domain(['D1', 'D2', 'DT', 'PD', 'T1', 'T2', 'T3', 'UNK'])
        .range(['#FFEAA7', '#DDA0DD', '#F39C12', '#FF6B6B', '#4ECDC4', '#45B7D1', '#96CEB4', '#95A5A6']);
      ...
      const legendData = [
        { zone: 'D1', label: 'D1 - Discharge Low' },
        { zone: 'D2', label: 'D2 - Discharge High' },
      ...
      legendData.forEach((item, i) => {
        const row = legend.append('g')
          .attr('transform', `translate(8, ${10 + i * 18})`);
  ...
  if (!data || data.length === 0) {
    return (
      <div style={styles.noDataContainer}>
        ...
        <h3>No Duval Triangle 6 Data Available</h3>
    ...
    <div style={styles.container} ref={containerRef}>
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <span style={styles.headerTitle}>Duval Triangle 6</span>
...
export default DuvalTriangle6Chart;